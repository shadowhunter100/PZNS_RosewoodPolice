...
function PZNS_SpawnPoliceNPCMarvin()
    ...
    if (isNPCActive == nil) then
        ...
        if (spawnSquare ~= nil) then
            ...
            if (npcSurvivor ~= nil) then
                ...
                Events.EveryOneMinute.Remove(PZNS_SpawnPoliceNPCMarvin);
            end
        else
            -- Cows: Else need to retry the spawning process until the square is loaded
            Events.EveryOneMinute.Add(PZNS_SpawnPoliceNPCMarvin);
        end
    end
end

-- Cows: NPC Cleanup function...
function PZNS_DeletePoliceNPCMarvin()
